...
class Drink {
	...
	factory Drink.fromMap(Map<String, dynamic> data) => Drink(
				...
				strCreativeCommonsConfirmed: data['strCreativeCommonsConfirmed'] as String?,
  ...
  /// Converts [Drink] to a JSON string.
	...
	Drink copyWith({
		...
		return Drink(
			...
			strInstructionsZhHans: strInstructionsZhHans ?? this.strInstructionsZhHans,
			strInstructionsZhHant: strInstructionsZhHant ?? this.strInstructionsZhHant,
